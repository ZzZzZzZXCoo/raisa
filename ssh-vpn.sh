...
#installl
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/raisa/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/raisa/main/install.sh && chmod +x install.sh && sed -i -e 's/\r$//' install.sh && ./install.sh
